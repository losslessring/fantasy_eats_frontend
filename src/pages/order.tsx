...
export const Order = () => {
    ...
    //Subscriptions are not working. Probably due to the outdated apollo client library
    // const { data: subscribtionData } = useSubscription<
    //     orderUpdates,
    ...
    return (
        <div className="mt-32 container flex justify-center">
            <title>Order #{params.id} | Fantasy Eats</title>
